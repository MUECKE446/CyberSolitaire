...
public:
	static BOOL Init(); 
	virtual BOOL Open(LPCTSTR pFilename);                        // open an AVI file
	virtual BOOL Close();                                                        // close AVI File
	virtual BOOL Play(DWORD dwFlags, int nFirst = 0, int nLast = -1, int nRepeatDelay = 0);
